        ...
        rx.foreach(
            ...
            lambda tab: rx.el.button(
                ...
                class_name=rx.cond(
                    ...
                    "px-4 py-2 font-medium text-stone-500 hover:text-stone-800 dark:text-stone-400 dark:hover:text-stone-200 dark:text-stone-400 dark:hover:text-stone-200",
                ),
            ),
        ),
...
def add_activity_dialog() -> rx.Component:
    return rx.cond(
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.h2(
                    "Add Crop Activity", class_name="text-xl font-bold text-stone-800 dark:text-stone-100"
                ),
                rx.cond(
                ...
                rx.el.form(
                    rx.el.div(
                        ...
                        rx.el.label("Activity Type", class_name="text-sm font-medium dark:text-stone-200"),
                        rx.el.select(
                            rx.foreach(
                            ...
                            name="activity_type",
                            class_name="mt-1 w-full p-2 border rounded-md bg-white dark:bg-stone-800 dark:border-stone-600 dark:text-stone-100 min-h-[40px]",
                        ),
                        rx.el.label("Cost", class_name="text-sm font-medium dark:text-stone-200"),
                        rx.el.input(
                            name="cost",
                            type="number",
                            step="0.01",
                        ...
                        rx.el.label(
                            "Notes (Optional)",
                            class_name="text-sm font-medium col-span-2 dark:text-stone-200",
                        ),
                        rx.el.textarea(
                            name="notes",
                            class_name="mt-1 w-full p-2 border rounded-md col-span-2 h-20 dark:bg-stone-800 dark:border-stone-600 dark:text-stone-100",
                        ),
...
def add_harvest_dialog() -> rx.Component:
    return rx.cond(
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.h2(
                    "Record Harvest", class_name="text-xl font-bold text-stone-800 dark:text-stone-100"
                ),
                rx.cond(
                    CropState.dialog_error != "",
                    rx.el.div(
                ...
                rx.el.form(
                    rx.el.div(
                        ...
                        rx.el.label("Quantity", class_name="text-sm font-medium dark:text-stone-200"),
                        rx.el.input(
                            name="quantity",
                            type="number",
                            step="0.01",
                        ...
                        rx.el.label("Unit", class_name="text-sm font-medium dark:text-stone-200"),
                        rx.el.input(
                            name="unit",
                            placeholder="e.g., kg, bushels, tons",
                            class_name="mt-1 w-full p-2 border rounded-md dark:bg-stone-800 dark:border-stone-600 dark:text-stone-100 min-h-[40px]",
                        ),
                        rx.el.label("Income", class_name="text-sm font-medium dark:text-stone-200"),
                        rx.el.input(
                            name="income",
                            type="number",
                            step="0.01",
            ...
            rx.el.div(
                rx.foreach(
                    ...
                    lambda item: rx.el.div(
                        ...
                        rx.el.span(item["name"], class_name="text-sm text-stone-600 dark:text-stone-300"),
    ...
    return dashboard_layout(
        rx.cond(
            ...
            rx.cond(
                ...
                rx.el.div(
                    rx.el.h2(
                        "Crop not found", class_name="text-2xl font-bold text-stone-800 dark:text-stone-100"
                    ),
                    rx.el.p(
