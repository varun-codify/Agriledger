...
def category_card(category: dict) -> rx.Component:
    ...
    return rx.el.div(
        rx.icon(category["icon"], class_name="h-8 w-8 mx-auto mb-2 text-stone-600 dark:text-stone-300"),
        ...
        class_name=rx.cond(
            ...
            "p-4 rounded-xl border border-stone-200 bg-white text-stone-700 dark:text-stone-200 dark:bg-stone-800 dark:border-stone-600 cursor-pointer hover:shadow-sm hover:border-stone-300 transition-all",
        ),
    )
