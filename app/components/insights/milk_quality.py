...
def quality_score_card() -> rx.Component:
    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                rx.el.p("Avg Fat %", class_name="text-xs text-stone-500 dark:text-stone-400"),
                rx.el.p(
            ...
            rx.el.div(
                rx.el.p("Avg SNF %", class_name="text-xs text-stone-500 dark:text-stone-400"),
                rx.el.p(
            ...
            rx.el.div(
                rx.el.p("Quality Score", class_name="text-xs text-stone-500 dark:text-stone-400"),
                rx.el.p(
                    rx.cond(
                ...
                class_name="text-center p-4 bg-stone-50 rounded-xl dark:bg-stone-800",
            ),
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.p(
                    ...
                    class_name="text-sm text-stone-600 ml-2 dark:text-stone-300",
                ),
